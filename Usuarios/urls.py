...
urlpatterns=[
    ...
    # path('eliminar/<int:id_usuario>',views.eliminar,name='eliminar-fun'),
    ...
    path('perfil-form/', PerfilUpdateView.as_view(),name='perfil'),
    path('eliminar/<int:id_usuario>/', EliminarUsuarioView.as_view(), name='eliminar'),
]